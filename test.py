...
class DeepSARSAgent:
    def __init__(self, state_size, action_size):
        ...
        self.epsilon = 0.01 
        # epsilon만 선언한 이유? 할인율과 학습률은 선언하지 않고 - 학습 과정 조절할 필요가 없기 때문에 
        self.model = DeepSARSA(self.action_size)
        self.model.load_weights('save_model/trained/model') # trained 모델 재현 위해서
...
if __name__ == "__main__":
    ...
    EPISODES = 10 # episode의 수 - train과 다르다. 
